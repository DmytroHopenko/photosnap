...
export default function Header() {
  ...
  useEffect(() => {
    // Отримайте поточний URL
    const currentPath = location.pathname;

    // Перевірте, чи це URL на іншу сторінку, на яку ви хочете видалити клас
    if (currentPath === '/' || currentPath === '/features' || currentPath === '/stories' || currentPath === '/pricing') {
      // Видаліть клас з потрібного елемента
      const element = document.querySelector('body');
      if (element) {
        element.classList.remove('no_scroll');
      }
    }
  }, [location.pathname]);
  ...
  useEffect(() => {
    ...
    // Встановлюємо слухача події при завантаженні компонента
  ...
  return (
    <header>
        ...
        <nav className={`mobile_menu ${isOpen ? 'open' : ''}`}>
          ...
          <Link to='/' className='special'>get an invite</Link>
        </nav>
